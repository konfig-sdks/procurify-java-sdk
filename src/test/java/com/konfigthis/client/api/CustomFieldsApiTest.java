...
public class CustomFieldsApiTest {
     ...
     */
    @Test
    public void getOrderItemCustomFieldsTest() throws ApiException {
        String fieldType = null;
        String format = null;
        Boolean metaIsActive = null;
        Integer page = null;
        Integer pageSize = null;
        PaginatedCustomFieldReadList response = api.getOrderItemCustomFields()
                .fieldType(fieldType)
                .format(format)
     ...
     */
    @Test
    public void updateOrderItemCustomFieldDropdownChoicesTest() throws ApiException {
        String name = null;
        String fieldType = null;
        Integer id = null;
        String defaultValue = null;
        Boolean isRequired = null;
        List<String> fieldChoices = null;
        String format = null;
        CustomFieldReadSerializerSingle response = api.updateOrderItemCustomFieldDropdownChoices(name, fieldType, id)
