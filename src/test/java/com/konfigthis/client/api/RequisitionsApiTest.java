...
public class RequisitionsApiTest {
    ...
    private static RequisitionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new RequisitionsApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        ...
        List<RequisitionLineCreateRequest> lineItems = null;
        String format = null;
        RequisitionReadSerializerSingle response = api.create(requiredDate, locationName, departmentName, lineItems)
                .format(format)
                .execute();
     ...
     */
    @Test
    public void getAllOrderItemsTest() throws ApiException {
        ...
        Integer type = null;
        String unit = null;
        PaginatedOrderItemList response = api.getAllOrderItems()
                .account(account)
    ...
    public void getAllOrdersTest() throws ApiException {
        ...
        Integer page = null;
        Integer pageSize = null;
        LocalDate requiredDate0 = null;
        LocalDate requiredDate1 = null;
        String search = null;
        Integer status = null;
        Double totalPrice = null;
        PaginatedOrderReadList response = api.getAllOrders()
                .branch(branch)
