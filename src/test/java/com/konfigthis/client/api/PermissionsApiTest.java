...
public class PermissionsApiTest {
     ...
     */
    @Test
    public void getAvailableSystemRolesTest() throws ApiException {
        String format = null;
        String orderBy = null;
        Integer page = null;
        ...
        PaginatedPermissionGroupList response = api.getAvailableSystemRoles()
                .format(format)
                .orderBy(orderBy)
                .page(page)
                .pageSize(pageSize)
    ...
    public void listTest() throws ApiException {
        ...
        Integer pageSize = null;
        String search = null;
        PaginatedPermissionReadList response = api.list()
                .format(format)
                .orderBy(orderBy)
                .page(page)
                .pageSize(pageSize)
