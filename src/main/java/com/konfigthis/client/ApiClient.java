...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://your-domain.procurify.com";
    private String tokenUrl = "https://<your-domain>.procurify.com/oauth/token";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("M2MAuthentication", new HttpBearerAuth("bearer"));
        ...
        if (configuration != null) {
            ...
            if (configuration.tokenAuth != null) {
                this.setTokenAuth(configuration.tokenAuth);
            }
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("RemoteAuthentication", oauth);
        return oauth;
    }
    ...
    public String getTokenAuth() {
        return ((ApiKeyAuth) this.getAuthentication("tokenAuth")).getApiKey();
    }

    public void setTokenAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("tokenAuth")).setApiKey(apiKey);
    }

    public void setTokenAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("tokenAuth")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://your-domain.procurify.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://<your-domain>.procurify.com/oauth/token)
     * @return An instance of OkHttpClient
     */
