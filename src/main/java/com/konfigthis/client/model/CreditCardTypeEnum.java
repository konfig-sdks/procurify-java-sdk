...
/**
 * Gets or Sets CreditCardTypeEnum
 */
@JsonAdapter(CreditCardTypeEnum.Adapter.class)public enum CreditCardTypeEnum {
  ...
  CreditCardTypeEnum(Integer value) {
    this.value = value;
  }
  ...
  public static CreditCardTypeEnum fromValue(Integer value) {
