...
public class AccountRead {
  ...
  private Float budgetUsedApproved;
  ...
  private Float budgetUsedPurchased;
  ...
  **/
  ...
  public AccountRead accountCode(AccountCodeRead accountCode) {
  ...
  **/
  ...
  public AccountRead department(DepartmentSummary department) {
  ...
  **/
  ...
  public AccountRead budgetUsedApproved(Float budgetUsedApproved) {
  ...
  **/
  ...
  public Float getBudgetUsedApproved() {
    return budgetUsedApproved;
  }


  public void setBudgetUsedApproved(Float budgetUsedApproved) {
  ...
  public AccountRead budgetUsedPurchased(Float budgetUsedPurchased) {
  ...
  **/
  ...
  public Float getBudgetUsedPurchased() {
    return budgetUsedPurchased;
  }


  public void setBudgetUsedPurchased(Float budgetUsedPurchased) {
  ...
  public AccountRead startDatetime(OffsetDateTime startDatetime) {
  ...
  **/
  ...
  public AccountRead endDatetime(OffsetDateTime endDatetime) {
  ...
  **/
  ...
  public AccountRead budget(BigDecimal budget) {
  ...
  **/
  ...
  public AccountRead balanceApproved(BigDecimal balanceApproved) {
  ...
  **/
  ...
  public AccountRead balancePurchased(BigDecimal balancePurchased) {
  ...
  **/
  ...
  public AccountRead active(Boolean active) {
  ...
  **/
   ...
   * @return the AccountRead instance itself
   */
  public AccountRead putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountRead accountRead = (AccountRead) o;
    return Objects.equals(this.id, accountRead.id) &&
        Objects.equals(this.accountCode, accountRead.accountCode) &&
        Objects.equals(this.department, accountRead.department) &&
        Objects.equals(this.warningIndicator, accountRead.warningIndicator) &&
        Objects.equals(this.budgetUsedApproved, accountRead.budgetUsedApproved) &&
        Objects.equals(this.budgetUsedPurchased, accountRead.budgetUsedPurchased) &&
        Objects.equals(this.startDatetime, accountRead.startDatetime) &&
        Objects.equals(this.endDatetime, accountRead.endDatetime) &&
        Objects.equals(this.budget, accountRead.budget) &&
        Objects.equals(this.balanceApproved, accountRead.balanceApproved) &&
        Objects.equals(this.balancePurchased, accountRead.balancePurchased) &&
        Objects.equals(this.active, accountRead.active)&&
        Objects.equals(this.additionalProperties, accountRead.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, accountCode, department, warningIndicator, budgetUsedApproved, budgetUsedPurchased, startDatetime, endDatetime, budget, balanceApproved, balancePurchased, active, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountRead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountRead is not found in the empty JSON string", AccountRead.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountRead.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountRead>() {
           @Override
           public void write(JsonWriter out, AccountRead value) throws IOException {
           ...
           @Override
           public AccountRead read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountRead instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountRead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountRead
  * @throws IOException if the JSON string is invalid with respect to AccountRead
  */
  public static AccountRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountRead.class);
  }

 /**
  * Convert an instance of AccountRead to an JSON string
  *
  * @return JSON string
  */
