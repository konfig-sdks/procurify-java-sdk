...
public class Currency {
  ...
  **/
  ...
  public Currency base(Boolean base) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, rate, base, active, additionalProperties);
  }
