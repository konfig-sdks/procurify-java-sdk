...
import com.konfigthis.client.model.VendorPerformanceNullable;
...
public class VendorDetail {
  ...
  private VendorPerformanceNullable performance;
  ...
  **/
  ...
  public VendorDetail name(String name) {
  ...
  **/
  ...
  public VendorDetail active(Boolean active) {
  ...
  **/
  ...
  public VendorDetail addressLineOne(String addressLineOne) {
  ...
  **/
  ...
  public VendorDetail addressLineTwo(String addressLineTwo) {
  ...
  **/
  ...
  public VendorDetail postalCode(String postalCode) {
  ...
  **/
  ...
  public VendorDetail city(String city) {
  ...
  **/
  ...
  public VendorDetail stateProvince(String stateProvince) {
  ...
  **/
  ...
  public VendorDetail country(String country) {
  ...
  **/
  ...
  public VendorDetail phoneOne(String phoneOne) {
  ...
  **/
  ...
  public VendorDetail phoneTwo(String phoneTwo) {
  ...
  **/
  ...
  public VendorDetail fax(String fax) {
  ...
  **/
  ...
  public VendorDetail comments(String comments) {
  ...
  **/
  ...
  public VendorDetail contact(String contact) {
  ...
  **/
  ...
  public VendorDetail url(String url) {
  ...
  **/
  ...
  public VendorDetail externalId(String externalId) {
  ...
  **/
  ...
  public VendorDetail currency(Integer currency) {
  ...
  **/
  ...
  public VendorDetail paymentTermRef(PaymentTermNullable paymentTermRef) {
  ...
  **/
  ...
  public VendorDetail shippingTermRef(ShippingTermNullable shippingTermRef) {
  ...
  **/
  ...
  public VendorDetail paymentMethodRef(PaymentMethodNullable paymentMethodRef) {
  ...
  **/
  ...
  public VendorDetail shippingMethodRef(ShippingMethodNullable shippingMethodRef) {
  ...
  **/
  ...
  public VendorDetail tax(Integer tax) {
  ...
  **/
  ...
  public VendorDetail type(VendorTypeEnum type) {
  ...
  **/
  ...
  public VendorDetail defaultPaymentMethod(Integer defaultPaymentMethod) {
  ...
  **/
  ...
  public VendorDetail is1099Eligible(Boolean is1099Eligible) {
  ...
  **/
  ...
  public VendorDetail isAutoEmailPoEnabled(Boolean isAutoEmailPoEnabled) {
  ...
  **/
  ...
  public VendorDetail poPdfLabels(String poPdfLabels) {
  ...
  **/
  ...
  public VendorDetail performance(VendorPerformanceNullable performance) {
  ...
  **/
  ...
  public VendorPerformanceNullable getPerformance() {
    return performance;
  }


  public void setPerformance(VendorPerformanceNullable performance) {
  ...
  public VendorDetail vendorRequest(NestedVendorRequest vendorRequest) {
  ...
  **/
   ...
   * @return the VendorDetail instance itself
   */
  public VendorDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VendorDetail vendorDetail = (VendorDetail) o;
    return Objects.equals(this.id, vendorDetail.id) &&
        Objects.equals(this.name, vendorDetail.name) &&
        Objects.equals(this.active, vendorDetail.active) &&
        Objects.equals(this.addressLineOne, vendorDetail.addressLineOne) &&
        Objects.equals(this.addressLineTwo, vendorDetail.addressLineTwo) &&
        Objects.equals(this.postalCode, vendorDetail.postalCode) &&
        Objects.equals(this.city, vendorDetail.city) &&
        Objects.equals(this.stateProvince, vendorDetail.stateProvince) &&
        Objects.equals(this.country, vendorDetail.country) &&
        Objects.equals(this.phoneOne, vendorDetail.phoneOne) &&
        Objects.equals(this.phoneTwo, vendorDetail.phoneTwo) &&
        Objects.equals(this.fax, vendorDetail.fax) &&
        Objects.equals(this.email, vendorDetail.email) &&
        Objects.equals(this.comments, vendorDetail.comments) &&
        Objects.equals(this.contact, vendorDetail.contact) &&
        Objects.equals(this.url, vendorDetail.url) &&
        Objects.equals(this.externalId, vendorDetail.externalId) &&
        Objects.equals(this.dateModified, vendorDetail.dateModified) &&
        Objects.equals(this.currency, vendorDetail.currency) &&
        Objects.equals(this.paymentTermRef, vendorDetail.paymentTermRef) &&
        Objects.equals(this.shippingTermRef, vendorDetail.shippingTermRef) &&
        Objects.equals(this.paymentMethodRef, vendorDetail.paymentMethodRef) &&
        Objects.equals(this.shippingMethodRef, vendorDetail.shippingMethodRef) &&
        Objects.equals(this.paymentMethods, vendorDetail.paymentMethods) &&
        Objects.equals(this.tax, vendorDetail.tax) &&
        Objects.equals(this.type, vendorDetail.type) &&
        Objects.equals(this.defaultPaymentMethod, vendorDetail.defaultPaymentMethod) &&
        Objects.equals(this.creditcards, vendorDetail.creditcards) &&
        Objects.equals(this.is1099Eligible, vendorDetail.is1099Eligible) &&
        Objects.equals(this.overallScore, vendorDetail.overallScore) &&
        Objects.equals(this.isAutoEmailPoEnabled, vendorDetail.isAutoEmailPoEnabled) &&
        Objects.equals(this.poPdfLabels, vendorDetail.poPdfLabels) &&
        Objects.equals(this.performance, vendorDetail.performance) &&
        Objects.equals(this.vendorRequest, vendorDetail.vendorRequest)&&
        Objects.equals(this.additionalProperties, vendorDetail.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VendorDetail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VendorDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VendorDetail is not found in the empty JSON string", VendorDetail.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VendorDetail.openapiRequiredFields) {
      ...
      if (jsonObj.get("performance") != null && !jsonObj.get("performance").isJsonNull()) {
        VendorPerformanceNullable.validateJsonObject(jsonObj.getAsJsonObject("performance"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VendorDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VendorDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VendorDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VendorDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<VendorDetail>() {
           @Override
           public void write(JsonWriter out, VendorDetail value) throws IOException {
           ...
           @Override
           public VendorDetail read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VendorDetail instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VendorDetail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VendorDetail
  * @throws IOException if the JSON string is invalid with respect to VendorDetail
  */
  public static VendorDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VendorDetail.class);
  }

 /**
  * Convert an instance of VendorDetail to an JSON string
  *
  * @return JSON string
  */
