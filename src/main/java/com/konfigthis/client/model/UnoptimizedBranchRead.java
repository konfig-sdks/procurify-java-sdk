...
public class UnoptimizedBranchRead {
  ...
  public static final String SERIALIZED_NAME_FIELDS_CACHE = "fields_cache";
  @SerializedName(SERIALIZED_NAME_FIELDS_CACHE)
  private String fieldsCache;
  ...
  **/
  ...
  public UnoptimizedBranchRead externalId(String externalId) {
  ...
  **/
  ...
  public UnoptimizedBranchRead name(String name) {
  ...
  **/
  ...
  public UnoptimizedBranchRead url(URI url) {
  ...
  **/
  ...
  public UnoptimizedBranchRead logo(String logo) {
  ...
  **/
  ...
  public UnoptimizedBranchRead language(LanguageEnum language) {
  ...
  **/
  ...
  public UnoptimizedBranchRead multipleLocations(Boolean multipleLocations) {
  ...
  **/
  ...
  public UnoptimizedBranchRead locationTimezone(Object locationTimezone) {
  ...
  **/
  ...
  public UnoptimizedBranchRead userLimit(Long userLimit) {
  ...
  **/
  ...
  public UnoptimizedBranchRead budgetOvertureToggle(Boolean budgetOvertureToggle) {
  ...
  **/
  ...
  public UnoptimizedBranchRead purchaseFiltering(Boolean purchaseFiltering) {
  ...
  **/
  ...
  public UnoptimizedBranchRead catalogPermission(Boolean catalogPermission) {
  ...
  **/
  ...
  public UnoptimizedBranchRead separateExpenseApproval(Boolean separateExpenseApproval) {
  ...
  **/
  ...
  public UnoptimizedBranchRead standaloneTravelApproval(Boolean standaloneTravelApproval) {
  ...
  **/
  ...
  public UnoptimizedBranchRead phoneOne(String phoneOne) {
  ...
  **/
  ...
  public UnoptimizedBranchRead phoneTwo(String phoneTwo) {
  ...
  **/
  ...
  public UnoptimizedBranchRead fax(String fax) {
  ...
  **/
  ...
  public UnoptimizedBranchRead email(String email) {
  ...
  **/
  ...
  public UnoptimizedBranchRead fiscalYearEndDay(Long fiscalYearEndDay) {
  ...
  **/
  ...
  public UnoptimizedBranchRead fiscalYearEndMonth(Long fiscalYearEndMonth) {
  ...
  **/
  ...
  public UnoptimizedBranchRead timezone(TimezoneEnum timezone) {
  ...
  **/
  ...
  public UnoptimizedBranchRead ported(Boolean ported) {
  ...
  **/
  ...
  public UnoptimizedBranchRead portDate(OffsetDateTime portDate) {
  ...
  **/
  ...
  public UnoptimizedBranchRead active(Boolean active) {
  ...
  **/
  ...
  public UnoptimizedBranchRead fieldsCache(String fieldsCache) {
  ...
  **/
  ...
  public String getFieldsCache() {
    return fieldsCache;
  }


  public void setFieldsCache(String fieldsCache) {
  ...
  public UnoptimizedBranchRead activated(Boolean activated) {
  ...
  **/
  ...
  public UnoptimizedBranchRead setupStage(SetupStageEnum setupStage) {
  ...
  **/
  ...
  public UnoptimizedBranchRead localCurrency(Integer localCurrency) {
  ...
  **/
  ...
  public UnoptimizedBranchRead contactPerson(Integer contactPerson) {
  ...
  **/
  ...
  public UnoptimizedBranchRead buyerAddress(Integer buyerAddress) {
  ...
  **/
  ...
  public UnoptimizedBranchRead shippingAddress(Integer shippingAddress) {
  ...
  **/
   ...
   * @return the UnoptimizedBranchRead instance itself
   */
  public UnoptimizedBranchRead putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UnoptimizedBranchRead unoptimizedBranchRead = (UnoptimizedBranchRead) o;
    return Objects.equals(this.id, unoptimizedBranchRead.id) &&
        Objects.equals(this.externalId, unoptimizedBranchRead.externalId) &&
        Objects.equals(this.name, unoptimizedBranchRead.name) &&
        Objects.equals(this.url, unoptimizedBranchRead.url) &&
        Objects.equals(this.logo, unoptimizedBranchRead.logo) &&
        Objects.equals(this.language, unoptimizedBranchRead.language) &&
        Objects.equals(this.multipleLocations, unoptimizedBranchRead.multipleLocations) &&
        Objects.equals(this.locationTimezone, unoptimizedBranchRead.locationTimezone) &&
        Objects.equals(this.userLimit, unoptimizedBranchRead.userLimit) &&
        Objects.equals(this.budgetOvertureToggle, unoptimizedBranchRead.budgetOvertureToggle) &&
        Objects.equals(this.purchaseFiltering, unoptimizedBranchRead.purchaseFiltering) &&
        Objects.equals(this.catalogPermission, unoptimizedBranchRead.catalogPermission) &&
        Objects.equals(this.separateExpenseApproval, unoptimizedBranchRead.separateExpenseApproval) &&
        Objects.equals(this.standaloneTravelApproval, unoptimizedBranchRead.standaloneTravelApproval) &&
        Objects.equals(this.phoneOne, unoptimizedBranchRead.phoneOne) &&
        Objects.equals(this.phoneTwo, unoptimizedBranchRead.phoneTwo) &&
        Objects.equals(this.fax, unoptimizedBranchRead.fax) &&
        Objects.equals(this.email, unoptimizedBranchRead.email) &&
        Objects.equals(this.fiscalYearEndDay, unoptimizedBranchRead.fiscalYearEndDay) &&
        Objects.equals(this.fiscalYearEndMonth, unoptimizedBranchRead.fiscalYearEndMonth) &&
        Objects.equals(this.timezone, unoptimizedBranchRead.timezone) &&
        Objects.equals(this.beginDate, unoptimizedBranchRead.beginDate) &&
        Objects.equals(this.ported, unoptimizedBranchRead.ported) &&
        Objects.equals(this.portDate, unoptimizedBranchRead.portDate) &&
        Objects.equals(this.active, unoptimizedBranchRead.active) &&
        Objects.equals(this.fieldsCache, unoptimizedBranchRead.fieldsCache) &&
        Objects.equals(this.activated, unoptimizedBranchRead.activated) &&
        Objects.equals(this.setupStage, unoptimizedBranchRead.setupStage) &&
        Objects.equals(this.localCurrency, unoptimizedBranchRead.localCurrency) &&
        Objects.equals(this.contactPerson, unoptimizedBranchRead.contactPerson) &&
        Objects.equals(this.buyerAddress, unoptimizedBranchRead.buyerAddress) &&
        Objects.equals(this.shippingAddress, unoptimizedBranchRead.shippingAddress)&&
        Objects.equals(this.additionalProperties, unoptimizedBranchRead.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnoptimizedBranchRead {\n");
    ...
    sb.append("    fieldsCache: ").append(toIndentedString(fieldsCache)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fields_cache");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UnoptimizedBranchRead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnoptimizedBranchRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnoptimizedBranchRead is not found in the empty JSON string", UnoptimizedBranchRead.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnoptimizedBranchRead.openapiRequiredFields) {
      ...
      if (!jsonObj.get("fields_cache").isJsonNull() && (jsonObj.get("fields_cache") != null && !jsonObj.get("fields_cache").isJsonNull()) && !jsonObj.get("fields_cache").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fields_cache` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fields_cache").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnoptimizedBranchRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnoptimizedBranchRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnoptimizedBranchRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnoptimizedBranchRead.class));

       return (TypeAdapter<T>) new TypeAdapter<UnoptimizedBranchRead>() {
           @Override
           public void write(JsonWriter out, UnoptimizedBranchRead value) throws IOException {
           ...
           @Override
           public UnoptimizedBranchRead read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UnoptimizedBranchRead instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UnoptimizedBranchRead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UnoptimizedBranchRead
  * @throws IOException if the JSON string is invalid with respect to UnoptimizedBranchRead
  */
  public static UnoptimizedBranchRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnoptimizedBranchRead.class);
  }

 /**
  * Convert an instance of UnoptimizedBranchRead to an JSON string
  *
  * @return JSON string
  */
