...
/**
 * Gets or Sets PurchaseOrderStateEnum
 */
@JsonAdapter(PurchaseOrderStateEnum.Adapter.class)public enum PurchaseOrderStateEnum {
  ...
  PurchaseOrderStateEnum(Integer value) {
    this.value = value;
  }
  ...
  public static PurchaseOrderStateEnum fromValue(Integer value) {
