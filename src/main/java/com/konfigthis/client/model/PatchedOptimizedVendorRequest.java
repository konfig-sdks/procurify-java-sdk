...
public class PatchedOptimizedVendorRequest {
  ...
  public PatchedOptimizedVendorRequest() {
  }

  public PatchedOptimizedVendorRequest name(String name) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest active(Boolean active) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest addressLineOne(String addressLineOne) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest addressLineTwo(String addressLineTwo) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest postalCode(String postalCode) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest city(String city) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest stateProvince(String stateProvince) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest country(String country) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest phoneOne(String phoneOne) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest phoneTwo(String phoneTwo) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest fax(String fax) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest email(List<String> email) {
  ...
  public PatchedOptimizedVendorRequest addEmailItem(String emailItem) {
    if (this.email == null) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest comments(String comments) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest contact(String contact) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest url(String url) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest externalId(String externalId) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest currency(Integer currency) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest paymentTermRef(PaymentTermRequestNullable paymentTermRef) {
  ...
  **/
  ...
  public PaymentTermRequestNullable getPaymentTermRef() {
    return paymentTermRef;
  }


  public void setPaymentTermRef(PaymentTermRequestNullable paymentTermRef) {
  ...
  public PatchedOptimizedVendorRequest shippingTermRef(ShippingTermRequestNullable shippingTermRef) {
  ...
  **/
  ...
  public ShippingTermRequestNullable getShippingTermRef() {
    return shippingTermRef;
  }


  public void setShippingTermRef(ShippingTermRequestNullable shippingTermRef) {
  ...
  public PatchedOptimizedVendorRequest paymentMethodRef(PaymentMethodRequestNullable paymentMethodRef) {
  ...
  **/
  ...
  public PaymentMethodRequestNullable getPaymentMethodRef() {
    return paymentMethodRef;
  }


  public void setPaymentMethodRef(PaymentMethodRequestNullable paymentMethodRef) {
  ...
  public PatchedOptimizedVendorRequest shippingMethodRef(ShippingMethodRequestNullable shippingMethodRef) {
  ...
  **/
  ...
  public ShippingMethodRequestNullable getShippingMethodRef() {
    return shippingMethodRef;
  }


  public void setShippingMethodRef(ShippingMethodRequestNullable shippingMethodRef) {
  ...
  public PatchedOptimizedVendorRequest tax(Integer tax) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest type(VendorTypeEnum type) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest defaultPaymentMethod(Integer defaultPaymentMethod) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest is1099Eligible(Boolean is1099Eligible) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest overallScore(BigDecimal overallScore) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest isAutoEmailPoEnabled(Boolean isAutoEmailPoEnabled) {
  ...
  **/
  ...
  public PatchedOptimizedVendorRequest poPdfLabels(String poPdfLabels) {
  ...
  **/
   ...
   * @return the PatchedOptimizedVendorRequest instance itself
   */
  public PatchedOptimizedVendorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchedOptimizedVendorRequest patchedOptimizedVendorRequest = (PatchedOptimizedVendorRequest) o;
    return Objects.equals(this.name, patchedOptimizedVendorRequest.name) &&
        Objects.equals(this.active, patchedOptimizedVendorRequest.active) &&
        Objects.equals(this.addressLineOne, patchedOptimizedVendorRequest.addressLineOne) &&
        Objects.equals(this.addressLineTwo, patchedOptimizedVendorRequest.addressLineTwo) &&
        Objects.equals(this.postalCode, patchedOptimizedVendorRequest.postalCode) &&
        Objects.equals(this.city, patchedOptimizedVendorRequest.city) &&
        Objects.equals(this.stateProvince, patchedOptimizedVendorRequest.stateProvince) &&
        Objects.equals(this.country, patchedOptimizedVendorRequest.country) &&
        Objects.equals(this.phoneOne, patchedOptimizedVendorRequest.phoneOne) &&
        Objects.equals(this.phoneTwo, patchedOptimizedVendorRequest.phoneTwo) &&
        Objects.equals(this.fax, patchedOptimizedVendorRequest.fax) &&
        Objects.equals(this.email, patchedOptimizedVendorRequest.email) &&
        Objects.equals(this.comments, patchedOptimizedVendorRequest.comments) &&
        Objects.equals(this.contact, patchedOptimizedVendorRequest.contact) &&
        Objects.equals(this.url, patchedOptimizedVendorRequest.url) &&
        Objects.equals(this.externalId, patchedOptimizedVendorRequest.externalId) &&
        Objects.equals(this.currency, patchedOptimizedVendorRequest.currency) &&
        Objects.equals(this.paymentTermRef, patchedOptimizedVendorRequest.paymentTermRef) &&
        Objects.equals(this.shippingTermRef, patchedOptimizedVendorRequest.shippingTermRef) &&
        Objects.equals(this.paymentMethodRef, patchedOptimizedVendorRequest.paymentMethodRef) &&
        Objects.equals(this.shippingMethodRef, patchedOptimizedVendorRequest.shippingMethodRef) &&
        Objects.equals(this.tax, patchedOptimizedVendorRequest.tax) &&
        Objects.equals(this.type, patchedOptimizedVendorRequest.type) &&
        Objects.equals(this.defaultPaymentMethod, patchedOptimizedVendorRequest.defaultPaymentMethod) &&
        Objects.equals(this.is1099Eligible, patchedOptimizedVendorRequest.is1099Eligible) &&
        Objects.equals(this.overallScore, patchedOptimizedVendorRequest.overallScore) &&
        Objects.equals(this.isAutoEmailPoEnabled, patchedOptimizedVendorRequest.isAutoEmailPoEnabled) &&
        Objects.equals(this.poPdfLabels, patchedOptimizedVendorRequest.poPdfLabels)&&
        Objects.equals(this.additionalProperties, patchedOptimizedVendorRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, active, addressLineOne, addressLineTwo, postalCode, city, stateProvince, country, phoneOne, phoneTwo, fax, email, comments, contact, url, externalId, currency, paymentTermRef, shippingTermRef, paymentMethodRef, shippingMethodRef, tax, type, defaultPaymentMethod, is1099Eligible, overallScore, isAutoEmailPoEnabled, poPdfLabels, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchedOptimizedVendorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchedOptimizedVendorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchedOptimizedVendorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchedOptimizedVendorRequest is not found in the empty JSON string", PatchedOptimizedVendorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("payment_term_ref") != null && !jsonObj.get("payment_term_ref").isJsonNull()) {
        PaymentTermRequestNullable.validateJsonObject(jsonObj.getAsJsonObject("payment_term_ref"));
      }
      ...
      if (jsonObj.get("shipping_term_ref") != null && !jsonObj.get("shipping_term_ref").isJsonNull()) {
        ShippingTermRequestNullable.validateJsonObject(jsonObj.getAsJsonObject("shipping_term_ref"));
      }
      ...
      if (jsonObj.get("payment_method_ref") != null && !jsonObj.get("payment_method_ref").isJsonNull()) {
        PaymentMethodRequestNullable.validateJsonObject(jsonObj.getAsJsonObject("payment_method_ref"));
      }
      ...
      if (jsonObj.get("shipping_method_ref") != null && !jsonObj.get("shipping_method_ref").isJsonNull()) {
        ShippingMethodRequestNullable.validateJsonObject(jsonObj.getAsJsonObject("shipping_method_ref"));
      }
      if (!jsonObj.get("overall_score").isJsonNull() && (jsonObj.get("overall_score") != null && !jsonObj.get("overall_score").isJsonNull()) && !jsonObj.get("overall_score").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchedOptimizedVendorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchedOptimizedVendorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchedOptimizedVendorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchedOptimizedVendorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchedOptimizedVendorRequest>() {
           @Override
           public void write(JsonWriter out, PatchedOptimizedVendorRequest value) throws IOException {
           ...
           @Override
           public PatchedOptimizedVendorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchedOptimizedVendorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchedOptimizedVendorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchedOptimizedVendorRequest
  * @throws IOException if the JSON string is invalid with respect to PatchedOptimizedVendorRequest
  */
  public static PatchedOptimizedVendorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchedOptimizedVendorRequest.class);
  }

 /**
  * Convert an instance of PatchedOptimizedVendorRequest to an JSON string
  *
  * @return JSON string
  */
