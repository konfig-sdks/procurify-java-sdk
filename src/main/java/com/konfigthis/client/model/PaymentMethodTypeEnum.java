...
/**
 * Gets or Sets PaymentMethodTypeEnum
 */
@JsonAdapter(PaymentMethodTypeEnum.Adapter.class)public enum PaymentMethodTypeEnum {
  ...
  PaymentMethodTypeEnum(Integer value) {
    this.value = value;
  }
  ...
  public static PaymentMethodTypeEnum fromValue(Integer value) {
