...
public class OptimizedVendorRequest {
  ...
  public OptimizedVendorRequest() {
  }

  public OptimizedVendorRequest name(String name) {
  ...
  **/
  ...
  public OptimizedVendorRequest active(Boolean active) {
  ...
  **/
  ...
  public OptimizedVendorRequest addressLineOne(String addressLineOne) {
  ...
  **/
  ...
  public OptimizedVendorRequest addressLineTwo(String addressLineTwo) {
  ...
  **/
  ...
  public OptimizedVendorRequest postalCode(String postalCode) {
  ...
  **/
  ...
  public OptimizedVendorRequest city(String city) {
  ...
  **/
  ...
  public OptimizedVendorRequest stateProvince(String stateProvince) {
  ...
  **/
  ...
  public OptimizedVendorRequest country(String country) {
  ...
  **/
  ...
  public OptimizedVendorRequest phoneOne(String phoneOne) {
  ...
  **/
  ...
  public OptimizedVendorRequest phoneTwo(String phoneTwo) {
  ...
  **/
  ...
  public OptimizedVendorRequest fax(String fax) {
  ...
  **/
  ...
  public OptimizedVendorRequest email(List<String> email) {
  ...
  public OptimizedVendorRequest addEmailItem(String emailItem) {
  ...
  **/
  ...
  public OptimizedVendorRequest comments(String comments) {
  ...
  **/
  ...
  public OptimizedVendorRequest contact(String contact) {
  ...
  **/
  ...
  public OptimizedVendorRequest url(String url) {
  ...
  **/
  ...
  public OptimizedVendorRequest externalId(String externalId) {
  ...
  **/
  ...
  public OptimizedVendorRequest currency(Integer currency) {
  ...
  **/
  ...
  public OptimizedVendorRequest paymentTermRef(PaymentTermRequestNullable paymentTermRef) {
  ...
  **/
  ...
  public OptimizedVendorRequest shippingTermRef(ShippingTermRequestNullable shippingTermRef) {
  ...
  **/
  ...
  public OptimizedVendorRequest paymentMethodRef(PaymentMethodRequestNullable paymentMethodRef) {
  ...
  **/
  ...
  public OptimizedVendorRequest shippingMethodRef(ShippingMethodRequestNullable shippingMethodRef) {
  ...
  **/
  ...
  public OptimizedVendorRequest tax(Integer tax) {
  ...
  **/
  ...
  public OptimizedVendorRequest type(VendorTypeEnum type) {
  ...
  **/
  ...
  public OptimizedVendorRequest defaultPaymentMethod(Integer defaultPaymentMethod) {
  ...
  **/
  ...
  public OptimizedVendorRequest is1099Eligible(Boolean is1099Eligible) {
  ...
  **/
  ...
  public OptimizedVendorRequest overallScore(BigDecimal overallScore) {
  ...
  **/
  ...
  public OptimizedVendorRequest isAutoEmailPoEnabled(Boolean isAutoEmailPoEnabled) {
  ...
  **/
  ...
  public OptimizedVendorRequest poPdfLabels(String poPdfLabels) {
  ...
  **/
   ...
   * @return the OptimizedVendorRequest instance itself
   */
  public OptimizedVendorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OptimizedVendorRequest optimizedVendorRequest = (OptimizedVendorRequest) o;
    return Objects.equals(this.name, optimizedVendorRequest.name) &&
        Objects.equals(this.active, optimizedVendorRequest.active) &&
        Objects.equals(this.addressLineOne, optimizedVendorRequest.addressLineOne) &&
        Objects.equals(this.addressLineTwo, optimizedVendorRequest.addressLineTwo) &&
        Objects.equals(this.postalCode, optimizedVendorRequest.postalCode) &&
        Objects.equals(this.city, optimizedVendorRequest.city) &&
        Objects.equals(this.stateProvince, optimizedVendorRequest.stateProvince) &&
        Objects.equals(this.country, optimizedVendorRequest.country) &&
        Objects.equals(this.phoneOne, optimizedVendorRequest.phoneOne) &&
        Objects.equals(this.phoneTwo, optimizedVendorRequest.phoneTwo) &&
        Objects.equals(this.fax, optimizedVendorRequest.fax) &&
        Objects.equals(this.email, optimizedVendorRequest.email) &&
        Objects.equals(this.comments, optimizedVendorRequest.comments) &&
        Objects.equals(this.contact, optimizedVendorRequest.contact) &&
        Objects.equals(this.url, optimizedVendorRequest.url) &&
        Objects.equals(this.externalId, optimizedVendorRequest.externalId) &&
        Objects.equals(this.currency, optimizedVendorRequest.currency) &&
        Objects.equals(this.paymentTermRef, optimizedVendorRequest.paymentTermRef) &&
        Objects.equals(this.shippingTermRef, optimizedVendorRequest.shippingTermRef) &&
        Objects.equals(this.paymentMethodRef, optimizedVendorRequest.paymentMethodRef) &&
        Objects.equals(this.shippingMethodRef, optimizedVendorRequest.shippingMethodRef) &&
        Objects.equals(this.tax, optimizedVendorRequest.tax) &&
        Objects.equals(this.type, optimizedVendorRequest.type) &&
        Objects.equals(this.defaultPaymentMethod, optimizedVendorRequest.defaultPaymentMethod) &&
        Objects.equals(this.is1099Eligible, optimizedVendorRequest.is1099Eligible) &&
        Objects.equals(this.overallScore, optimizedVendorRequest.overallScore) &&
        Objects.equals(this.isAutoEmailPoEnabled, optimizedVendorRequest.isAutoEmailPoEnabled) &&
        Objects.equals(this.poPdfLabels, optimizedVendorRequest.poPdfLabels)&&
        Objects.equals(this.additionalProperties, optimizedVendorRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OptimizedVendorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OptimizedVendorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OptimizedVendorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptimizedVendorRequest is not found in the empty JSON string", OptimizedVendorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OptimizedVendorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptimizedVendorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptimizedVendorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptimizedVendorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptimizedVendorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OptimizedVendorRequest>() {
           @Override
           public void write(JsonWriter out, OptimizedVendorRequest value) throws IOException {
           ...
           @Override
           public OptimizedVendorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OptimizedVendorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OptimizedVendorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OptimizedVendorRequest
  * @throws IOException if the JSON string is invalid with respect to OptimizedVendorRequest
  */
  public static OptimizedVendorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptimizedVendorRequest.class);
  }

 /**
  * Convert an instance of OptimizedVendorRequest to an JSON string
  *
  * @return JSON string
  */
